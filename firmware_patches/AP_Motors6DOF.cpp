...
const AP_Param::GroupInfo AP_Motors6DOF::var_info[] = {
    ...
    // @Description: 0=Underwater (all motors), 1=Surface normal (motors 3,4 disabled), 2=Surface inverted (motors 1,2 disabled)
    // @Values: 0:Underwater,1:SurfaceNormal,2:SurfaceInverted
    // @User: Standard
    // @User: Standard
    AP_GROUPINFO("SURFACE_MODE", 14, AP_Motors6DOF, _surface_mode, 0),
...
void AP_Motors6DOF::setup_motors(motor_frame_class frame_class, motor_frame_type frame_type)
{
    ...
    case SUB_FRAME_VECTORED:
        ...
        add_motor_raw_6dof(AP_MOTORS_MOT_1,     0,              -1.0f,              1.0f,           0,                  1.0f,              0,           1);
        add_motor_raw_6dof(AP_MOTORS_MOT_2,     0,              -1.0f,              -1.0f,          0,                  1.0f,             0,          2);
        add_motor_raw_6dof(AP_MOTORS_MOT_3,     0,              1.0f,              1.0f,            0,                  1.0f,               0,           3);
        add_motor_raw_6dof(AP_MOTORS_MOT_4,     0,              1.0f,              -1.0f,           0,                  1.0f,               0,          4);
    ...
    case SUB_FRAME_SIMPLEROV_3:
        ...
        add_motor_raw_6dof(AP_MOTORS_MOT_1,     0,              0,              1.0f,          0,                  1.0f,               0,              1);
        add_motor_raw_6dof(AP_MOTORS_MOT_2,     0,              0,              -1.0f,          0,                  1.0f,               0,              2);
        add_motor_raw_6dof(AP_MOTORS_MOT_3,     0,              0,              0,              0,              0,                  0,              3);
        break;
    case SUB_FRAME_SIMPLEROV_4:
        _frame_class_string = "SIMPLEROV_4";
        add_motor_raw_6dof(AP_MOTORS_MOT_1,     0,              0,              1.0f,          0,                  1.0f,               0,              1);
        add_motor_raw_6dof(AP_MOTORS_MOT_2,     0,              0,              -1.0f,          0,                  1.0f,               0,              2);
        add_motor_raw_6dof(AP_MOTORS_MOT_3,     0,              0,              0,              1.0f,                  0,               -1.0f,              3);
        add_motor_raw_6dof(AP_MOTORS_MOT_4,     0,              0,              0,              1.0f,                  0,               1.0f,              4);
        break;
...
void AP_Motors6DOF::output_to_motors()
{
    ...
    // surface mode: disable motors exposed above water
    // 1 = normal surface (disable top thrusters 3,4)
    // 2 = inverted surface (disable 1,2 which are now on top after 180° flip)
    if (_surface_mode == 1) {
        motor_out[AP_MOTORS_MOT_3] = 1500;
        motor_out[AP_MOTORS_MOT_4] = 1500;
    } else if (_surface_mode == 2) {
        motor_out[AP_MOTORS_MOT_1] = 1500;
        motor_out[AP_MOTORS_MOT_2] = 1500;
    }
